...
function getMostPopularBoxes($numList){
	...
	if (sizeof($explodedSentence)<2) {
		$htmlcode=" is <span style= \"color:white; class:popularitylist; font-weight:bold;\">";
		...
		$htmlcode="es are <span style= \"color:white; class:popularitylist; font-weight:bold; \">";
		for ($i=0; $i <sizeof($explodedSentence)-1 ; $i++) { 
			$htmlcode.=$explodedSentence[$i];
			$htmlcode.=",";
		}
		$htmlcode.="</span>";
		$htmlcode.=" and ";
		$htmlcode.="<span style= \"color:white;class:popularitylist;  font-weight:bold; \">";
